<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownlist_no_forceselection_initvalue.aspx.cs"
    Inherits="FineUI.Examples.dropdownlist.dropdownlist_no_forceselection_initvalue" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" runat="server" Width="500px" EnableCollapse="true"
            ShowBorder="True" Title="下拉列表（不强制选择，初始值）" ShowHeader="True">
            <Items>
        ...
        <ul>
            ...
            <li>ForceSelection="false"：不强制选择</li>
        </ul>
    </form>
</body>
</html>
