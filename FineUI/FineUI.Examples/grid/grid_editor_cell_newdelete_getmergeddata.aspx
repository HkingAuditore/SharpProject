<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_editor_cell_newdelete_getmergeddata.aspx.cs"
    Inherits="FineUI.Examples.grid.grid_editor_cell_newdelete_getmergeddata" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格（双击编辑）" EnableCollapse="true" Width="850px"
            ...
            EnableCheckBoxSelect="true" DataIDField="Id">
            <Toolbars>
