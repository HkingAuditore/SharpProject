<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_lockcolumn_summary_scrollbar.aspx.cs"
    Inherits="FineUI.Examples.grid.grid_lockcolumn_summary_scrollbar" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="表格" EnableCollapse="true" Width="800px" Height="350px"
            ...
            <Columns>
                <f:RowNumberField />
                <f:BoundField Width="100px" EnableLock="true" Locked="true" ColumnID="name" DataField="Name" DataFormatString="{0}"
                    HeaderText="姓名" />
                <f:TemplateField Width="80px" EnableLock="true" HeaderText="性别">
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# GetGender(Eval("Gender")) %>'></asp:Label>
                    </ItemTemplate>
                </f:TemplateField>
                <f:BoundField Width="80px" EnableLock="true" DataField="EntranceYear" HeaderText="入学年份" />
