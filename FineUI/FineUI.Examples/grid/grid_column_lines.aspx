...
<body>
    ...
    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格"  EnableCollapse="true" Width="800px"
        runat="server" DataKeyNames="Guid" EnableColumnLines="true" EnableCheckBoxSelect="true">
        <Columns>
            ...
            <f:ImageField Width="120px" DataImageUrlField="Group" DataImageUrlFormatString="~/res/images/16/{0}.png"
