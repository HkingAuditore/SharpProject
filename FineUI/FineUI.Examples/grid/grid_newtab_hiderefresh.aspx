<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_newtab_hiderefresh.aspx.cs" Inherits="FineUI.Examples.grid.grid_newtab_hiderefresh" %>
...
<body>
    ...
    <script>
        ...
        function getNewWindowUrl() {
            return F.baseUrl + 'grid/grid_newtab_hiderefresh_window.aspx?parenttabid=' + parent.getActiveTabId();
        }


        function getEditWindowUrl(id, name) {
            return F.baseUrl + 'grid/grid_newtab_hiderefresh_window.aspx?id=' + id + '&name=' + name + '&parenttabid=' + parent.getActiveTabId();
        }
